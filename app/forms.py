...
class FertilizerPredictionForm(forms.Form):
    temperature = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Temperature (in Celsius)'}), required=True)
    humidity = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Humidity'}), required=True)
    moisture = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Moisture'}), required=True)
    soil_type = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Soil Type'}), required=True)
    crop_type = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Crop Type'}), required=True)
    nitrogen = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter level of Nitrogen'}), required=True)
    potassium = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter level of Potassium'}), required=True)
    phosphorous = forms.FloatField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Enter level of Phosphorous'}), required=True)
...
class ContactForm(forms.Form):
    ...
    subject = forms.CharField(max_length=150, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Subject'}), required=True)
    message = forms.CharField(widget=forms.Textarea(attrs={'class':'form-control', 'placeholder':'Your Message'}), required=True)

class FindDiseaseForm(forms.Form):
    crop_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Crop Name'}), required=True)
    disease_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Disease Name'}), required=True)
