...
urlpatterns = [
    ...
    # Add disease prediction URL
    path('visitor_disease_prediction', visitor_disease_prediction, name='visitor_disease_prediction'),
    ...
    path('visitor_fertilizer_prediction', visitor_fertilizer_prediction, name='visitor_fertilizer_prediction'),
