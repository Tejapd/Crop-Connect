...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tejapuli06@gmail.com'
EMAIL_HOST_PASSWORD = 'ktkr ysra vurt avpt'  # Replace with actual password or use environment variable
EMAIL_RECEIVING_USER = ['tejapuli06@gmail.com']